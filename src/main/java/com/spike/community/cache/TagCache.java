...
public class TagCache {
    public static List<TagDTO> get(){
        ...
        program.setTags(Arrays.asList("js","php","css","c","c++","c#","java","html","html5","node","node.js","python","golang","ruby","asp.net","swift","bash","shell","lua","kotlin","perl"));
        tagDTOS.add(program);

        TagDTO framework = new TagDTO();
        framework.setCategoryName("开发框架");
        framework.setTags(Arrays.asList("laravelspring","express","django","flask","yii","ruby-on-rails","tornado","koa","struts"));
